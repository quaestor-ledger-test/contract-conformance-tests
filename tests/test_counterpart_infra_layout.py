...
SOURCE_REPO = "https://github.com/quaestor-ledger/quaestor-infra.git"
SOURCE_SHA = "5f99e89666358f6929e64b18c2689733e466564f"
...
class CounterpartInfraLayoutTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls._tmp = tempfile.TemporaryDirectory(prefix="quaestor-infra-contract-")
